...
Take a collection of topologies $$X_i$$, we define the *product topology* on $$X_1 \times X_2 \times ... $$
...
Take the the unit circle $$ S^1 = \{ x^2 + y^2 = 1 \} $$ and the open interval $$L = (a,b)$$. Intuitively it's easy to see they are not homeomorphic. You make a hole on the circle and it's still path-connected, you make a hole on the line and you two disconnected intervals. That's the main gist of it. Let's write it a bit more formally:

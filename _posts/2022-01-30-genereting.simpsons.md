...
Why did it fail? Probably the network's architecture (specifically the tweaks) was not good. Also, a latent representation of 1024 might be too small to represent the whole image with enough accuracy.
